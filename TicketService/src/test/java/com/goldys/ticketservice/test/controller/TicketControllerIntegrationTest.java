...
public class TicketControllerIntegrationTest {
    ...
    public void setUp() {
        ...
        ticket.setTicketId("30");
        ticketRepository.save(ticket);
    }

    @AfterEach
    public void tearDown() {
        ticketRepository.deleteById("30");
    }
    ...
    public void getTicketByTicketIdSuccess() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/ticketservice/30").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
                .andDo(MockMvcResultHandlers.print());
    }
    ...
    public void getTicketByTicketIdFailure() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/ticketservice/40").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isNotFound())
                .andDo(MockMvcResultHandlers.print());
    }
