package com.goldys.userservice.test;
...
public class TestCoverageFinder {
    ...
    public void testModelTestCaseCoverage() throws ClassNotFoundException {
        ...
        boolean flag = false;
        int counter = 0;
        Method[] methods = Class.forName("com.goldys.userservice.test.model.UserTest")
                .getDeclaredMethods();
    ...
    public void testServiceTestCaseCoverage() throws ClassNotFoundException {
        ...
        boolean flag = false;
        int counter = 0;
        Method[] methods = Class.forName("com.goldys.userservice.test.service.UserServiceTest")
                .getDeclaredMethods();
        for (Method method : methods) {
            if ((method.getAnnotation(Test.class)) != null) {
                flag = true;
    ...
    public void testControllerTestCaseCoverage() throws ClassNotFoundException {
        ...
        boolean flag = false;
        int counter = 0;
        Method[] methods = Class.forName("com.goldys.userservice.test.controller.UserControllerTest")
                .getDeclaredMethods();
        for (Method method : methods) {
            if ((method.getAnnotation(Test.class)) != null) {
                flag = true;
